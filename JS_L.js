...
________________________________________№3 Переменные_________________________________________________
...
let z = 5;
if (1) {   
    let z = 7; // но если здесь убрать let смотри ниже 77
    console.log(z); // вкв 7
}
console.log(z); // вкв 5
...
77 - в этом случае нижний console.log(z); выдаст 7 js будет действовать так же как если бы
z внутри блока было объявлена с помощью var а не с помощью let, но
