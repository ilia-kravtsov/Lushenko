...
// в логе мы получим 524 а не 29 и соо3тв. тип данных у 524 будет string
...
// то есть isNaN это функция которая проверяет что введенное значение не явялется числом
// тогда она даёт true
